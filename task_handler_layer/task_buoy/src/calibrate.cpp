...
//*********************************************************************************************************************************************\\    
 ...
 //   cvNamedWindow( "Contours", CV_WINDOW_NORMAL );
    ...
    Mat  hsv_frame,thresholded,thresholded1,thresholded2,thresholded3,filtered;
...
//        }
        ...
        split( hsv_frame,thresholded_hsv);
        ...
        imshow( "F1", thresholded_hsv[0]); // individual filters
        imshow( "F2", thresholded_hsv[1] );
        imshow( "F3", thresholded_hsv[2] );
